...
## We need to make 4 plot in one screen
png("plot4.png", width = 480, height = 480)
par(mfrow = c(2,2))

## plot 1
plot(datatime, data$Global_active_power, type = 'l', ylab = "Global Active Power", xlab = "", cex = 2)

## plot 2
plot(datatime, data$Voltage, type = 'l', ylab = "Voltage")
...
## plot 4
plot(datatime, data$Global_reactive_power, type = "l", ylab = "Global_reactive_power")
dev.off()